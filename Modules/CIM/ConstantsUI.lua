...
-- ICON METRICS (XML Support)
-- Referenced by SharedTemplates.xml; must be defined before the template XML loads.
BETTERUI_ICON_SIZE_MEDIUM = 28          -- Square size for menu-entry status/main icons.
BETTERUI_STATUS_INDICATOR_OFFSET_X = -2 -- Gap between status indicator and main icon.
BETTERUI_EQUIPPED_ICON_OFFSET_X = -2    -- Gap between equipped icon and main icon.
