...
local SETTINGS_METADATA_REGISTRY = {
    ...
    Nameplates = {
        ...
        moveReticlePrompt = {
            labelStringId = SI_BETTERUI_NAMEPLATES_MOVE_RETICLE,
            tooltipStringId = SI_BETTERUI_NAMEPLATES_MOVE_RETICLE_TOOLTIP,
            defaultValue = false,
            dependency = nil,
            sortGroup = "positioning",
            resetGroup = "positioning",
        ...
        reticlePromptOffsetX = {
            labelStringId = SI_BETTERUI_NAMEPLATES_RETICLE_OFFSET_X,
            tooltipStringId = SI_BETTERUI_NAMEPLATES_OFFSET_X_TOOLTIP,
            defaultValue = 0,
            dependency = nil,
            sortGroup = "positioning",
        ...
        reticlePromptOffsetY = {
            labelStringId = SI_BETTERUI_NAMEPLATES_RETICLE_OFFSET_Y,
            tooltipStringId = SI_BETTERUI_NAMEPLATES_OFFSET_Y_TOOLTIP,
            defaultValue = 0,
            dependency = nil,
            sortGroup = "positioning",
