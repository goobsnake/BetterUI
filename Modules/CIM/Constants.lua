...
Purpose: Core constants for the Common Interface Module (CIM).
         Includes Timing constants, UI basics, Module identifiers, Search bar,
         Currency footer configuration, Carousel settings, and Header/Footer geometry.
Author: BetterUI Team
Last Modified: 2026-03-14

Note: UI layout, backward-compatibility aliases, colors, icons, sort schema,
      and header layout constants are in ConstantsUI.lua.
]]
