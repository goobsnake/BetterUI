...
--- Ensures the vertical fade gradient is valid.
---
--- Purpose: Applies specific top/bottom fades without replacing the instance method.
--- Mechanics:
...
---
function BETTERUI_VerticalParametricScrollList:EnsureValidGradient()
