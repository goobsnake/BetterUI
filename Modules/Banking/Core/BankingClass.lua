...
Rationale: Subclasses BETTERUI.Interface.Window to provide a custom banking experience.
Mechanism: Inherits from Window base class to leverage shared header, footer, and list functionality.
]]
