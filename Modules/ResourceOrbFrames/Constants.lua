...
BETTERUI_ORB_FRAMES = {
    ...
    bars = {
        ...
        quickslot = {
            x = 270, -- Horizontal offset (+ right, - left)
            y = -48, -- Vertical nudge from bar midpoint (+ down, - up)
        },
        ...
        customFrontBar = {
            ...
            quickslotButton = {
                ...
                offsetY = 9, -- Quickslot vertical (+ down, - up)
            },
            companionButton = {
                offsetX = 0, -- Companion horizontal (+ right, - left)
                offsetY = 0, -- Companion vertical from the quickslot line (+ down, - up)
            },
