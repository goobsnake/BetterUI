...
BETTERUI.CIM.ProtectionPolicy = {
    CanDestroyItem = function(_bagId, _slotIndex)
        return allowDestroy
    end,
}
...
do
    ...
    local destroyed = BETTERUI.Inventory.TryDestroyItem(1, 2, true, true)
...
do
    ...
    local destroyed = BETTERUI.Inventory.TryDestroyItem(1, 2, true, false)
