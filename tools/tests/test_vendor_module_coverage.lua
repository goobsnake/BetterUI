...
local vendorCoverageTargets = {
    ...
    "Modules/Vendor/Core/Policy/VendorModePolicy.lua",
    "Modules/Vendor/Core/Presentation/VendorSelectionRuntime.lua",
    "Modules/Vendor/Core/VendorSafeExecute.lua",
    "Modules/Vendor/Core/Bridge/VendorNativeStoreBridge.lua",
    "Modules/Vendor/Core/VendorBootstrapRuntime.lua",
    "Modules/Vendor/Core/VendorComponentCatalog.lua",
    "Modules/Vendor/Core/Lifecycle/VendorEventBridge.lua",
    "Modules/Vendor/Core/Lifecycle/VendorInteractionRuntime.lua",
    "Modules/Vendor/Core/VendorBatchRuntime.lua",
    "Modules/Vendor/Core/Lifecycle/VendorControllerRuntime.lua",
    "Modules/Vendor/Core/Presentation/VendorPresentationRuntime.lua",
    "Modules/Vendor/Core/VendorClass.lua",
    "Modules/Vendor/Core/List/VendorRowSetup.lua",
