...
ZO_CreateStringId("SI_BETTERUI_ORBS_DESC", "启用 ARPG 风格的生命和资源球。")
ZO_CreateStringId("SI_BETTERUI_ORBS_ENABLED", "启用 BetterUI Orbs")
ZO_CreateStringId("SI_BETTERUI_ORBS_ENABLED_TOOLTIP", "切换 ARPG 风格的生命和资源球。")
ZO_CreateStringId("SI_BETTERUI_ORBS_SCALE", "缩放")
ZO_CreateStringId("SI_BETTERUI_ORBS_SCALE_TOOLTIP", "框架的整体大小。")
ZO_CreateStringId("SI_BETTERUI_ORBS_OFFSET", "垂直偏移 (上/下)")
ZO_CreateStringId("SI_BETTERUI_ORBS_OFFSET_TOOLTIP", "向上/向下移动框架。正值向上移动；负值向下移动。")
ZO_CreateStringId("BETTERUI_ORBS_USE_CUSTOM_TEXTURES", "使用自定义纹理")
ZO_CreateStringId("BETTERUI_ORBS_USE_CUSTOM_TEXTURES_TOOLTIP", "启用此选项以使用 'BetterUI/Modules/GeneralInterface/CustomOrbTextures' 中的纹理。您必须将自己的纹理放置在那里，并使用正确的文件名。")
ZO_CreateStringId("BETTERUI_ORBS_DOUBLE_BAR", "启用双动作条")
ZO_CreateStringId("BETTERUI_ORBS_DOUBLE_BAR_TOOLTIP", "显示双动作条背景和活动条指示器。如果您使用 Fancy Action Bar 等插件或只是想要视觉美感，这很有用。")
ZO_CreateStringId("SI_BETTERUI_ENABLE_CAROUSEL_NAV", "经典分类导航")
ZO_CreateStringId("SI_BETTERUI_ENABLE_CAROUSEL_NAV_TOOLTIP", "使用经典选项卡栏导航，而不是现代轮播风格。")
