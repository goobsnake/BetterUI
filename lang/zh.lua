...
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_USE_CUSTOM_TEXTURES", "使用自定义纹理")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_USE_CUSTOM_TEXTURES_TOOLTIP", "启用此选项以使用 'BetterUI/Modules/GeneralInterface/CustomOrbTextures' 中的纹理。您必须将自己的纹理放置在那里，并使用正确的文件名。")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_SIZE", "冷却文本大小")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_SIZE_TOOLTIP", "调整技能栏上显示的冷却计时器文本的字体大小。")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_COLOR", "冷却文本颜色")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_COLOR_TOOLTIP", "选择技能栏上显示的冷却计时器文本的颜色。")
