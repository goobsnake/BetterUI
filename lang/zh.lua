...
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_INDEPENDENT_ORB_OFFSET", "独立移动球体")
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_INDEPENDENT_ORB_OFFSET_TOOLTIP", "启用后，生命值和资源球体可以与技能栏分开放置。")
...
ZO_CreateStringId("SI_BETTERUI_TH_CANNOT_LIST_BOUND", "已绑定的物品无法在交易所挂单。")
