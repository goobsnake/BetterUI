...
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_USE_CUSTOM_TEXTURES", "Benutzerdefinierte Texturen verwenden")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_USE_CUSTOM_TEXTURES_TOOLTIP", "Aktivieren, um Texturen aus 'BetterUI/Modules/GeneralInterface/CustomOrbTextures' zu verwenden. Sie müssen Ihre eigenen Texturen dort mit den korrekten Dateinamen platzieren.")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_SIZE", "Abklingzeit Textgröße")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_SIZE_TOOLTIP", "Passen Sie die Schriftgröße für den Abklingzeit-Timer-Text auf den Fertigkeitsleisten an.")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_COLOR", "Abklingzeit Textfarbe")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_COLOR_TOOLTIP", "Wählen Sie die Farbe für den Abklingzeit-Timer-Text auf den Fertigkeitsleisten.")
