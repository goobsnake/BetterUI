...
ZO_CreateStringId("SI_BETTERUI_ORBS_DESC", "Aktiviert die Gesundheits- und Ressourcenkugeln im ARPG-Stil.")
ZO_CreateStringId("SI_BETTERUI_ORBS_ENABLED", "BetterUI Orbs aktivieren")
ZO_CreateStringId("SI_BETTERUI_ORBS_ENABLED_TOOLTIP", "Schaltet die Gesundheits- und Ressourcenkugeln im ARPG-Stil ein/aus.")
ZO_CreateStringId("SI_BETTERUI_ORBS_SCALE", "Skalierung")
ZO_CreateStringId("SI_BETTERUI_ORBS_SCALE_TOOLTIP", "Gesamtgröße des Rahmens.")
ZO_CreateStringId("SI_BETTERUI_ORBS_OFFSET", "Vertikaler Versatz (Auf/Ab)")
ZO_CreateStringId("SI_BETTERUI_ORBS_OFFSET_TOOLTIP", "Bewegt den Rahmen nach oben/unten. Positiv bewegt nach oben; negativ bewegt nach unten.")
ZO_CreateStringId("BETTERUI_ORBS_USE_CUSTOM_TEXTURES", "Benutzerdefinierte Texturen verwenden")
ZO_CreateStringId("BETTERUI_ORBS_USE_CUSTOM_TEXTURES_TOOLTIP", "Aktivieren, um Texturen aus 'BetterUI/Modules/GeneralInterface/CustomOrbTextures' zu verwenden. Sie müssen Ihre eigenen Texturen dort mit den korrekten Dateinamen platzieren.")
