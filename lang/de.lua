...
ZO_CreateStringId("SI_BETTERUI_SEARCH_NO_RESULTS", "Keine Gegenstände gefunden")
...
ZO_CreateStringId("SI_BETTERUI_FOOTER_KEYS_LABEL", "SCHLÜSSEL:")
...
ZO_CreateStringId("SI_BETTERUI_CURRENCY_RESET", "Währungssichtbarkeit- und Reihenfolge-Einstellungen zurücksetzen")
...
ZO_CreateStringId("SI_BETTERUI_CURRENCY_ENABLE_LIMIT_WARNING",
    "Maximale sichtbare Währungen erreicht (<<1>>). Deaktiviere eine Währung, bevor du eine andere aktivierst.")
ZO_CreateStringId("SI_BETTERUI_GENERAL_RESET", "Allgemeine Einstellungen zurücksetzen")
ZO_CreateStringId("SI_BETTERUI_GENERAL_RESET_TOOLTIP",
    "Setzt alle Einstellungen in diesem Allgemein-Bereich auf Standardwerte zurück.")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_SIZE", "Größe")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_SIZE_TOOLTIP", "Passe die Größe des Namensschildtextes an. Standard ist 16.")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RESET", "Namensschild-Einstellungen zurücksetzen")
...
ZO_CreateStringId("SI_BETTERUI_NAME_FONT_RESET", "Namensspalten-Schrifteinstellungen zurücksetzen")
ZO_CreateStringId("SI_BETTERUI_NAME_FONT_RESET_TOOLTIP", "Namensschrift-Einstellungen auf Standard zurücksetzen.")
ZO_CreateStringId("SI_BETTERUI_COLUMN_FONT_RESET", "Schrifteinstellungen der anderen Spalten zurücksetzen")
...
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_INDEPENDENT_ORB_OFFSET", "Kugeln unabhängig bewegen")
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_INDEPENDENT_ORB_OFFSET_TOOLTIP", "Wenn aktiviert, können die Lebens- und Ressourcenkugeln unabhängig von der Aktionsleiste positioniert werden.")
...
ZO_CreateStringId("SI_BETTERUI_ENHANCED_TOOLTIPS_RESET", "Tooltip-Einstellungen zurücksetzen")
...
ZO_CreateStringId("SI_BETTERUI_REMOVE_DELETE_MAIL_CONFIRM", "Löschbestätigung für Post überspringen")
...
ZO_CreateStringId("SI_BETTERUI_CAST_BAR_RESET", "Zauberleisten-Einstellungen zurücksetzen")
ZO_CreateStringId("SI_BETTERUI_MOUNT_STAMINA_BAR_RESET", "Reittierleisten-Einstellungen zurücksetzen")
...
ZO_CreateStringId("SI_BETTERUI_ICON_RESEARCHABLE_TRAIT_TOOLTIP",
    "Zeige ein Symbol nach Gegenständen mit erforschbarer Eigenschaft.")
...
ZO_CreateStringId("SI_BETTERUI_ICON_UNKNOWN_RECIPE_TOOLTIP",
    "Zeige ein Symbol nach Rezepten, die noch nicht gelernt wurden.")
...
ZO_CreateStringId("SI_BETTERUI_SHOW_CRAFTING_MARKET_PRICE_TOOLTIP", "Zeigt Marktpreise auf Handwerks- und Verbesserungs-Tooltips an, wenn eine Preisquelle (TTC, MM oder ATT) verfügbar ist.")
...
ZO_CreateStringId("SI_BETTERUI_SHOW_QUICKSLOT_COOLDOWN_TOOLTIP",
    "Zeigt einen Abklingzeit-Timer auf der Schnellzugriffstaste an und ersetzt die Anzahl während der Abklingzeit.")

-- Ultimate Number Display Settings
ZO_CreateStringId("SI_BETTERUI_ULTIMATE_DISPLAY_HEADER", "Ultimative Fähigkeit Anzeige")
...
ZO_CreateStringId("SI_BETTERUI_SHOW_ULTIMATE_NUMBER_TOOLTIP",
    "Zeigt den aktuellen Wert deiner ultimativen Fähigkeit auf der Ultimativen-Taste an.")
ZO_CreateStringId("SI_BETTERUI_ULTIMATE_TEXT_SIZE", "Ultimative Textgröße")
ZO_CreateStringId("SI_BETTERUI_ULTIMATE_TEXT_SIZE_TOOLTIP", "Schriftgröße für die Ultimative-Anzeige.")
ZO_CreateStringId("SI_BETTERUI_ULTIMATE_TEXT_COLOR", "Ultimative Textfarbe")
ZO_CreateStringId("SI_BETTERUI_ULTIMATE_TEXT_COLOR_TOOLTIP", "Farbe für die Ultimative-Anzeige.")
...
ZO_CreateStringId("SI_BETTERUI_COMBAT_GLOW_ENABLED_TOOLTIP",
    "Zeigt ein pulsierendes rot/oranges Leuchten um die Fähigkeitsleiste im Kampf an.")
...
ZO_CreateStringId("SI_BETTERUI_COMBAT_AUDIO_ENABLED_TOOLTIP",
    "Spielt einen Ton beim Betreten und Verlassen des Kampfes ab.")
...
ZO_CreateStringId("SI_BETTERUI_BANK_NO_FUNDS", "Nicht genügend Guthaben für die Überweisung.")
...
ZO_CreateStringId("SI_BETTERUI_STOW_PROMPT", "Wähle die Menge zum Verstauen")
...
ZO_CreateStringId("SI_BETTERUI_VENDOR_GENERAL_DESC",
    "Konfiguriere das Kernverhalten des Händlers, einschließlich Navigation und Stapeloptionen. Diese Einstellungen gelten nur für die Gamepad-UI.")
...
ZO_CreateStringId("SI_BETTERUI_VENDOR_BATCH_JUNK_SELL_TOOLTIP",
    "Wenn aktiviert, bietet eine Schnellaktion zum Verkauf aller Junk-Gegenstände bei einem Händler.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_FONT_HEADER", "Schriftanpassung")
ZO_CreateStringId("SI_BETTERUI_VENDOR_FONT_DESC",
    "Passe Schriftarten für die Händlerliste an. Lege unterschiedliche Schriftarten für Namensspalte und andere Spalten fest.")
...
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_TOOLTIP", "Wähle die Schriftart für Gegenstandsnamen.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_SIZE", "Größe")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_SIZE_TOOLTIP", "Wähle die Schriftgröße für Gegenstandsnamen.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_STYLE", "Schriftstil")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_STYLE_TOOLTIP", "Wähle den Schriftstil für Gegenstandsnamen.")
...
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_TOOLTIP", "Wähle die Schriftart für Spaltendaten.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_SIZE", "Größe")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_SIZE_TOOLTIP", "Wähle die Schriftgröße für Spaltendaten.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_STYLE", "Schriftstil")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_STYLE_TOOLTIP", "Wähle den Schriftstil für Spaltendaten.")
...
ZO_CreateStringId("SI_BETTERUI_VENDOR_TAB_BUYBACK", "Zurückkaufen")
...
ZO_CreateStringId("SI_BETTERUI_VENDOR_TITLE", "Erweiterter Händler")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NO_JUNK", "Keine Junk-Gegenstände zum Verkaufen.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NO_REPAIR_ITEMS", "Keine Gegenstände müssen repariert werden.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NO_BUYBACK_ITEMS", "Keine Gegenstände zum Zurückkaufen.")
...
ZO_CreateStringId("SI_BETTERUI_TH_CANNOT_LIST_BOUND", "Gebundene Gegenstände können nicht im Handelshaus angeboten werden.")
ZO_CreateStringId("SI_BETTERUI_TH_ENTER_PRICE", "Bitte gib einen Preis für das Angebot ein.")
ZO_CreateStringId("SI_BETTERUI_TH_GENERAL_HEADER", "Allgemein")
ZO_CreateStringId("SI_BETTERUI_TH_GENERAL_DESC", "Konfiguriere das BetterUI-Handelshaus. Diese Einstellungen gelten nur für die Gamepad-Oberfläche.")
ZO_CreateStringId("SI_BETTERUI_TH_FONT_HEADER", "Schriftart-Anpassung")
ZO_CreateStringId("SI_BETTERUI_TH_FONT_DESC", "Passe die Schriftarten für die Handelshausliste an.")
...
ZO_CreateStringId("SI_BETTERUI_TH_GUILD_NEXT", "Nächste Gilde")
ZO_CreateStringId("SI_BETTERUI_TH_NEXT_PAGE", "Nächste Seite")
