...
ZO_CreateStringId("SI_BETTERUI_MASTER_SETTINGS_HEADER", "General Settings")
ZO_CreateStringId("SI_BETTERUI_MASTER_SETTINGS_TITLE", "BetterUI Settings")
ZO_CreateStringId("SI_BETTERUI_ENABLED_MODULE_SETTINGS_DESC", "Each tab has its module toggle and settings. Disabled modules remain available.")
ZO_CreateStringId("SI_BETTERUI_ENABLED_MODULE_SETTINGS_HEADER", "Module Tabs")
...
ZO_CreateStringId("SI_BETTERUI_ENABLE_TOOLTIPS_TOOLTIP", "Enhances gamepad tooltips and general UI.")
...
ZO_CreateStringId("SI_BETTERUI_MASTER_RESET_ALL", "Reset All")
ZO_CreateStringId("SI_BETTERUI_MASTER_RESET_ALL_TOOLTIP", "Reset all BetterUI settings to defaults. Reload UI after reset.")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_DESC", "Customize enhanced nameplate text.")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RESET", "Reset Appearance")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RESET_TOOLTIP", "Reset nameplate font, style, and size to defaults.")
...
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_RESET", "Reset Orbs")
...
ZO_CreateStringId("SI_BETTERUI_GENERAL_INTERFACE_GENERAL_DESC", "General interface behavior.")
ZO_CreateStringId("SI_BETTERUI_ENHANCED_TOOLTIPS_HEADER", "Enhanced Tooltips")
ZO_CreateStringId("SI_BETTERUI_ENHANCED_TOOLTIPS_DESC", "Tooltip content and market integrations.")
...
ZO_CreateStringId("SI_BETTERUI_RESET_SKILL_BAR", "Reset Skill Bar")
...
ZO_CreateStringId("SI_BETTERUI_ROF_ELEM_LOCK_TOOLTIP", "Lock this element in place. Turn off to drag it or use offsets.")
...
ZO_CreateStringId("SI_BETTERUI_BUILOG_CHAT", "Chat output")
ZO_CreateStringId("SI_BETTERUI_BUILOG_CHAT_TOOLTIP", "Show INFO/WARN/ERROR in chat.")
ZO_CreateStringId("SI_BETTERUI_BUILOG_POPUPS", "Suppress error popups")
ZO_CreateStringId("SI_BETTERUI_BUILOG_POPUPS_TOOLTIP", "Hide error popups while logging; errors still write to Interface.log.")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_POSITION_DESC", "Move ESO's compass frame and reticle interaction text when they overlap BetterUI elements.")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_MOVE_COMPASS_TOOLTIP", "Apply the compass frame offset while Enhanced Nameplates is enabled.")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_MOVE_RETICLE", "Move Reticle Prompt")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_MOVE_RETICLE_TOOLTIP", "Apply the reticle interaction prompt offset while Enhanced Nameplates is enabled.")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RETICLE_OFFSET_X", "Reticle Prompt X")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RETICLE_OFFSET_Y", "Reticle Prompt Y")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RESET_POSITIONS", "Reset Positions")
