...
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_USE_CUSTOM_TEXTURES", "Использовать свои текстуры")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_USE_CUSTOM_TEXTURES_TOOLTIP", "Включите, чтобы использовать текстуры из 'BetterUI/Modules/GeneralInterface/CustomOrbTextures'. Вы должны поместить туда свои текстуры с правильными именами файлов.")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_SIZE", "Размер текста перезарядки")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_SIZE_TOOLTIP", "Настройте размер шрифта для текста таймера перезарядки, отображаемого на панелях способностей.")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_COLOR", "Цвет текста перезарядки")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_COLOR_TOOLTIP", "Выберите цвет для текста таймера перезарядки, отображаемого на панелях способностей.")
