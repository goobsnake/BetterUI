...
ZO_CreateStringId("SI_BETTERUI_SAVE_EQUIP_CONFIRM_EQUIP_BOE",
    "Экипировав <<t:1>>, вы навсегда привяжете его к своей учетной записи.")
...
ZO_CreateStringId("SI_BETTERUI_ENABLE_COMPANION_JUNK_TOOLTIP",
    "Включает «Отметить как хлам» для предметов спутника. Требуется совместимый аддон (например, FCO Companion).")
...
ZO_CreateStringId("SI_BETTERUI_CURRENCY_DESC",
    "Настройте отображаемые валюты и их порядок. Используйте пресеты для быстрой настройки или настройте индивидуально.")
ZO_CreateStringId("SI_BETTERUI_CURRENCY_PRESET", "Быстрый пресет")
ZO_CreateStringId("SI_BETTERUI_CURRENCY_PRESET_TOOLTIP",
    "Применить пресет конфигурации отображения валют. Пользовательские настройки будут перезаписаны.")
...
ZO_CreateStringId("SI_BETTERUI_INV_FONT_DESC",
    "Настройте шрифты для списка инвентаря. Установите разные шрифты для столбца Название и других столбцов (Тип, Черта, Стат, Цена).")
...
ZO_CreateStringId("SI_BETTERUI_BANK_FONT_DESC",
    "Настройте шрифты для списка банка. Установите разные шрифты для столбца Название и других столбцов (Тип, Черта, Стат, Цена).")
...
ZO_CreateStringId("SI_BETTERUI_LEFT_ORB_SIZE_TOOLTIP",
    "Регулирует размер левой сферы когда орнамент скрыт. 1.0 = 100%, 1.1 = 110%, 1.2 = 120%")
...
ZO_CreateStringId("SI_BETTERUI_HIDE_RIGHT_ORNAMENT_TOOLTIP",
    "Скрывает декоративный орнамент вокруг правой (магия/выносливость) сферы")
ZO_CreateStringId("SI_BETTERUI_RIGHT_ORB_SIZE", "Размер правой сферы")
ZO_CreateStringId("SI_BETTERUI_RIGHT_ORB_SIZE_TOOLTIP",
    "Регулирует размер правой сферы когда орнамент скрыт. 1.0 = 100%, 1.1 = 110%, 1.2 = 120%")
...
ZO_CreateStringId("SI_BETTERUI_ATT_INTEGRATION_TOOLTIP",
    "Добавляет информацию о цене ATT во всплывающие подсказки предметов")
...
ZO_CreateStringId("SI_BETTERUI_MM_INTEGRATION_TOOLTIP",
    "Добавляет информацию Master Merchant во всплывающие подсказки предметов")
...
ZO_CreateStringId("SI_BETTERUI_MOUNT_BAR_ENABLED_TOOLTIP",
    "Отображает панель выносливости маунта под правым орнаментом, когда вы верхом")
...
ZO_CreateStringId("SI_BETTERUI_FOOTER_BAG_CAPACITY", "СУМКА:")
ZO_CreateStringId("SI_BETTERUI_FOOTER_BANK_CAPACITY", "БАНК:")
...
ZO_CreateStringId("SI_BETTERUI_DESTROY_CONFIRM_GENERIC",
    "Вы уверены, что хотите уничтожить этот предмет? Это действие необратимо.")
ZO_CreateStringId("SI_BETTERUI_INV_ACTION_QUICKSLOT_UNASSIGN", "Убрать из быстрого слота")
ZO_CreateStringId("SI_BETTERUI_INV_EQUIP", "Экипировать")
ZO_CreateStringId("SI_BETTERUI_FEATURE_FLAGS_HEADER", "Экспериментальные функции")
ZO_CreateStringId("SI_BETTERUI_FEATURE_FLAGS_DESC",
    "Переключить экспериментальные или дополнительные функции. Некоторые изменения могут потребовать /reloadui.")
...
ZO_CreateStringId("SI_BETTERUI_BANK_DEPOSIT_QUANTITY", "Сколько внести?")
...
ZO_CreateStringId("SI_BETTERUI_VENDOR_GENERAL_HEADER", "Общие")
ZO_CreateStringId("SI_BETTERUI_VENDOR_GENERAL_DESC",
    "Настройте основные параметры торговца, включая навигацию и пакетные операции. Эти параметры применяются только к интерфейсу геймпада.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_BATCH_JUNK_SELL", "Пакетная продажа хлама")
ZO_CreateStringId("SI_BETTERUI_VENDOR_BATCH_JUNK_SELL_TOOLTIP",
    "Если включено, у торговца появляется быстрый вариант продать весь хлам сразу.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_FONT_HEADER", "Настройка шрифтов")
ZO_CreateStringId("SI_BETTERUI_VENDOR_FONT_DESC",
    "Настройте шрифты для списка торговца. Можно задать разные шрифты для колонки названия и остальных колонок.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_SUBMENU", "Шрифт колонки названия")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT", "Шрифт")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_TOOLTIP", "Выберите шрифт для названий предметов.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_SIZE", "Размер")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_SIZE_TOOLTIP", "Выберите размер шрифта для названий предметов.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_STYLE", "Стиль шрифта")
ZO_CreateStringId("SI_BETTERUI_VENDOR_NAME_FONT_STYLE_TOOLTIP", "Выберите стиль шрифта для названий предметов.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_SUBMENU", "Шрифт остальных колонок")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT", "Шрифт")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_TOOLTIP", "Выберите шрифт для данных в колонках.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_SIZE", "Размер")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_SIZE_TOOLTIP", "Выберите размер шрифта для данных в колонках.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_STYLE", "Стиль шрифта")
ZO_CreateStringId("SI_BETTERUI_VENDOR_COLUMN_FONT_STYLE_TOOLTIP", "Выберите стиль шрифта для данных в колонках.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_CANNOT_AFFORD", "Недостаточно средств для покупки этого предмета.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_CANNOT_CARRY", "Недостаточно места в инвентаре.")
ZO_CreateStringId("SI_BETTERUI_VENDOR_TAB_BUY", "Купить")
ZO_CreateStringId("SI_BETTERUI_VENDOR_TAB_SELL", "Продать")
ZO_CreateStringId("SI_BETTERUI_VENDOR_TAB_REPAIR", "Ремонт")
ZO_CreateStringId("SI_BETTERUI_VENDOR_TAB_BUYBACK", "Выкуп")
ZO_CreateStringId("SI_BETTERUI_VENDOR_TAB_FENCE_SELL", "Продать краденое")
...
ZO_CreateStringId("SI_BETTERUI_TH_TITLE", "Улучшенный торговый дом")
ZO_CreateStringId("SI_BETTERUI_TH_TAB_BROWSE", "Просмотр")
ZO_CreateStringId("SI_BETTERUI_TH_TAB_SELL", "Продать")
ZO_CreateStringId("SI_BETTERUI_TH_TAB_LISTINGS", "Мои объявления")
ZO_CreateStringId("SI_BETTERUI_TH_SEARCH", "Поиск")
ZO_CreateStringId("SI_BETTERUI_TH_SEARCH_COOLDOWN", "Поиск перезаряжается. Пожалуйста, подождите.")
ZO_CreateStringId("SI_BETTERUI_TH_NO_GUILD", "Нет гильдии")
ZO_CreateStringId("SI_BETTERUI_TH_LIST_ITEM", "Создать объявление")
ZO_CreateStringId("SI_BETTERUI_TH_CANCEL_LISTING", "Отменить объявление")
ZO_CreateStringId("SI_BETTERUI_TH_CANNOT_LIST_BOUND", "Привязанные предметы нельзя выставить на торговом доме.")
ZO_CreateStringId("SI_BETTERUI_TH_ENTER_PRICE", "Пожалуйста, введите цену для объявления.")
ZO_CreateStringId("SI_BETTERUI_TH_GENERAL_HEADER", "Общие")
ZO_CreateStringId("SI_BETTERUI_TH_GENERAL_DESC", "Настройте поведение BetterUI на торговом доме. Эти настройки применяются только к интерфейсу геймпада.")
ZO_CreateStringId("SI_BETTERUI_TH_FONT_HEADER", "Настройка шрифта")
ZO_CreateStringId("SI_BETTERUI_TH_FONT_DESC", "Настройте шрифты для списка предметов торгового дома.")
ZO_CreateStringId("SI_BETTERUI_FONT_NAME_COLUMN", "Шрифт столбца названий")
ZO_CreateStringId("SI_BETTERUI_FONT_OTHER_COLUMNS", "Шрифт других столбцов")
ZO_CreateStringId("SI_BETTERUI_TH_PRICE_LABEL", "Цена объявления")
ZO_CreateStringId("SI_BETTERUI_TH_GUILD_PREV", "Предыдущая гильдия")
ZO_CreateStringId("SI_BETTERUI_TH_GUILD_NEXT", "Следующая гильдия")
ZO_CreateStringId("SI_BETTERUI_TH_NEXT_PAGE", "Следующая страница")
ZO_CreateStringId("SI_BETTERUI_TH_PREV_PAGE", "Предыдущая страница")
