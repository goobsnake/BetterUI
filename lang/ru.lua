...
ZO_CreateStringId("SI_BETTERUI_ORBS_DESC", "Включить сферы здоровья и ресурсов в стиле ARPG.")
ZO_CreateStringId("SI_BETTERUI_ORBS_ENABLED", "Включить BetterUI Orbs")
ZO_CreateStringId("SI_BETTERUI_ORBS_ENABLED_TOOLTIP", "Переключить сферы здоровья и ресурсов в стиле ARPG.")
ZO_CreateStringId("SI_BETTERUI_ORBS_SCALE", "Масштаб")
ZO_CreateStringId("SI_BETTERUI_ORBS_SCALE_TOOLTIP", "Общий размер рамки.")
ZO_CreateStringId("SI_BETTERUI_ORBS_OFFSET", "Вертикальное смещение (Вверх/Вниз)")
ZO_CreateStringId("SI_BETTERUI_ORBS_OFFSET_TOOLTIP", "Переместить рамку вверх/вниз. Положительное значение перемещает вверх, отрицательное - вниз.")
ZO_CreateStringId("BETTERUI_ORBS_USE_CUSTOM_TEXTURES", "Использовать свои текстуры")
