...
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_USE_CUSTOM_TEXTURES", "カスタムテクスチャを使用")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_USE_CUSTOM_TEXTURES_TOOLTIP", "これを有効にすると、'BetterUI/Modules/GeneralInterface/CustomOrbTextures' のテクスチャが使用されます。正しいファイル名で独自のテクスチャをそこに配置する必要があります。")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_SIZE", "クールダウンテキストサイズ")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_SIZE_TOOLTIP", "スキルバーに表示されるクールダウンタイマーテキストのフォントサイズを調整します。")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_COLOR", "クールダウンテキストカラー")
ZO_CreateStringId("BETTERUI_RESOURCE_ORB_FRAMES_COOLDOWN_TEXT_COLOR_TOOLTIP", "スキルバーに表示されるクールダウンタイマーテキストの色を選択します。")
