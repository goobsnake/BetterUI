...
ZO_CreateStringId("SI_BETTERUI_ORBS_DESC", "ARPGスタイルのヘルスおよびリソースオーブを有効にします。")
ZO_CreateStringId("SI_BETTERUI_ORBS_ENABLED", "BetterUI Orbsを有効にする")
ZO_CreateStringId("SI_BETTERUI_ORBS_ENABLED_TOOLTIP", "ARPGスタイルのヘルスおよびリソースオーブを切り替えます。")
ZO_CreateStringId("SI_BETTERUI_ORBS_SCALE", "スケール")
ZO_CreateStringId("SI_BETTERUI_ORBS_SCALE_TOOLTIP", "フレーム全体のサイズ。")
ZO_CreateStringId("SI_BETTERUI_ORBS_OFFSET", "垂直オフセット（上/下）")
ZO_CreateStringId("SI_BETTERUI_ORBS_OFFSET_TOOLTIP", "フレームを上下に移動します。正の値は上に、負の値は下に移動します。")
ZO_CreateStringId("BETTERUI_ORBS_USE_CUSTOM_TEXTURES", "カスタムテクスチャを使用")
