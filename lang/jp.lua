...
ZO_CreateStringId("SI_BETTERUI_MASTER_SETTINGS_HEADER", "一般設定")
ZO_CreateStringId("SI_BETTERUI_MASTER_SETTINGS_TITLE", "BetterUI設定")
ZO_CreateStringId("SI_BETTERUI_ENABLED_MODULE_SETTINGS_DESC", "各タブにはモジュールの切り替えと設定があります。無効なモジュールも表示されます。")
...
ZO_CreateStringId("SI_BETTERUI_MASTER_RESET_ALL", "すべてリセット")
ZO_CreateStringId("SI_BETTERUI_MASTER_RESET_ALL_TOOLTIP", "BetterUI のすべての設定を既定値に戻します。復元した既定値を完全に適用するには、その後 UI を再読み込みしてください。")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RESET", "外観をリセット")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RESET_TOOLTIP", "ネームプレートのフォント、スタイル、サイズを既定値に戻します。")
...
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_RESET", "オーブをリセット")
...
ZO_CreateStringId("SI_BETTERUI_RESET_SKILL_BAR", "スキルバーをリセット")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RESET_POSITIONS", "位置をリセット")
