...
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_INDEPENDENT_ORB_OFFSET", "オーブを個別に移動")
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_INDEPENDENT_ORB_OFFSET_TOOLTIP", "有効にすると、体力とリソースのオーブをアクションバーとは別に配置できます。")
...
ZO_CreateStringId("SI_BETTERUI_VENDOR_GENERAL_DESC",
    "ベンダーの基本動作（ナビゲーションや一括オプションを含む）を設定します。これらの設定はゲームパッドUIにのみ適用されます。")
...
ZO_CreateStringId("SI_BETTERUI_TH_CANNOT_LIST_BOUND", "バインドされたアイテムは取引所に出品できません。")
