...
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_ORB_OFFSET_Y", "オーブのオフセット（上下）")
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_ORB_OFFSET_Y_TOOLTIP", "デフォルト位置に対するオーブペアの垂直オフセット。")
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_ORB_OFFSET_X", "オーブのオフセット（左右）")
ZO_CreateStringId("SI_BETTERUI_RESOURCE_ORB_FRAMES_ORB_OFFSET_X_TOOLTIP", "デフォルト位置に対するオーブペアの水平オフセット。")
...
ZO_CreateStringId("SI_BETTERUI_BUILOG_POPUPS", "エラーポップアップを抑制")
ZO_CreateStringId("SI_BETTERUI_BUILOG_POPUPS_TOOLTIP", "記録中はエラーポップアップを隠します。エラーはInterface.logに残ります。")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_POSITION_DESC", "ESOのコンパスフレームと照準のインタラクションテキストがBetterUI要素と重なる場合に移動します。")
...
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_MOVE_RETICLE", "照準プロンプトを移動")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_MOVE_RETICLE_TOOLTIP", "強化ネームプレートが有効な間、照準インタラクションプロンプトのオフセットを適用します。")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RETICLE_OFFSET_X", "照準プロンプト X")
ZO_CreateStringId("SI_BETTERUI_NAMEPLATES_RETICLE_OFFSET_Y", "照準プロンプト Y")
